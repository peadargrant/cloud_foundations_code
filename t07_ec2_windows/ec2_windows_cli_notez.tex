...
\subsection{Determining the public IP}\label{determining-the-public-ip}
...
pass an additional parameter to \texttt{get-password-data} to decrypt
this using your private key. Obviously replace the private key path with
your own!
...
\subsection{Starting RDP client from
PowerShell}\label{starting-rdp-client-from-powershell}

The RDP client is a program called \texttt{mstsc.exe}. To show its
options type
